      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="index2.php?name=North America">Amérique du Nord</a>
            <a class="dropdown-item" href="index2.php?name=South America">Amérique du Sud</a>
            <a class="dropdown-item" href="index2.php?name=Asia">Asie</a>
            <a class="dropdown-item" href="index2.php?name=Europe">Europe</a>
            <a class="dropdown-item" href="index2.php?name=Oceania">Océanie</a>
            <a class="dropdown-item" href="index2.php?name=Antarctica">Antarctique</a>
